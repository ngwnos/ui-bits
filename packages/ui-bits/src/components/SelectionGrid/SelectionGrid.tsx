...
export type SelectionGridVariant = "grid" | "gradient";
...
export type SelectionGridProps<Item = unknown> =
  | SelectionGridGridProps<Item>
  | SelectionGridGradientProps;

function GridSelectionGrid<Item>({
  items,
  getKey,
  renderItem,
  getLabel,
...
function GradientSelectionGrid({
...
export default function SelectionGrid<Item>(props: SelectionGridProps<Item>) {
  if (props.variant === "gradient") {
    const context = React.useContext(SliderStoreContext);
    if (!context) {
      return (
        <SliderStoreProvider>
          <GradientSelectionGrid {...props} />
        </SliderStoreProvider>
      );
    }
    return <GradientSelectionGrid {...props} />;
  }
  return <GridSelectionGrid {...props} />;
}
