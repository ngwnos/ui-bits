"use strict";const G=require("react/jsx-runtime"),s=require("react"),dt=require("typegpu"),pt=require("./panelGap-C0MXgSjL.cjs"),mt=require("./SegmentBar-BflaPbZe.cjs"),gt="var(--ui-bits-color-a, #2f2f2f)",bt="var(--ui-bits-color-b, #f0f0f0)",Ge="#ffffff",xt=1,vt=.35,Rt=1,Mt=6,ne=.4,oe=360,ce=512,De=8,Xe=8,Ye=12,wt=Ye*Float32Array.BYTES_PER_ELEMENT;let xe=null,re=null;async function _t(){return typeof navigator>"u"||!navigator.gpu?null:xe||(re||(re=dt.init().then(t=>(xe=t,t)).catch(t=>(console.error("ColorFieldPicker: TypeGPU init failed",t),re=null,null))),re)}function yt(){return`
...
//# sourceMappingURL=ColorFieldPicker-CdepFQ1O.cjs.map
